...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 339.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "midi number in (string length)",
					"id" : "obj-4",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 58.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "dampen in (can be audio signal)",
					"id" : "obj-5",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.0, 58.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "decay in (can be audio signal)",
					"id" : "obj-3",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 455.0, 31.0, 141.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 296.0, 31.0, 130.0, 20.0 ],
									"text" : "in 2 @comment decay"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 296.0, 72.0, 49.0, 20.0 ],
									"text" : "clip 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 352.0, 65.0, 103.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 504.0, 65.0, 103.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 352.0, 200.5, 157.0, 67.0 ],
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 305.5, 345.0, 68.0, 345.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 464.5, 390.0, 81.5, 390.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
,
					"patching_rect" : [ 75.0, 171.0, 172.0, 20.0 ],
					"text" : "gen~"
				}
